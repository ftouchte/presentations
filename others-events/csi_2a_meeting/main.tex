...
\begin{frame}{Nuclear GPDs}
    \begin{itemize}
        \item The Generalized Parton Distributions (GPDs) contains combines the notion of PDFs and FFs, along with their correlations
        ...
        % \end{itemize}
        \item We can access GPDs from a free proton or from a nucleus as a whole
    ...
    \includegraphics[width=0.5\linewidth]{figures/emc_effect.png}
        ...
        \begin{itemize}
            ...
            \item CLAS eg6 : first coherent DVCS off He4
                \begin{itemize}
                    ...
                    \item The measured BSA is twice the one measured on the free proton
                \end{itemize}
