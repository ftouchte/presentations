...
\title{Nuclear tomography with the ALERT detector at JLab}
...
\begin{frame}{Waveform classification}
    ...
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\linewidth]{figures/wfType6.pdf} & 
            \includegraphics[width=0.3\linewidth]{figures/wfType5.pdf} & 
                \includegraphics[width=0.3\linewidth]{figures/wfType4.pdf} \\
        \includegraphics[width=0.3\linewidth]{figures/wfType3.pdf} & 
            \includegraphics[width=0.3\linewidth]{figures/wfType2.pdf} & 
                \includegraphics[width=0.3\linewidth]{figures/wfType1.pdf} \\
    \end{tabular}
\end{frame}
