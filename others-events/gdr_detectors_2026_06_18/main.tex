...
\begin{frame}{Particle identification}
    \begin{itemize}
        \item While the tracking algorithm and the calibration are not over, we are already able to identify particle with the AHDC
...
\begin{frame}{Conclusion}
    \begin{itemize}
        \item The AHDC developed at IJCLab plays a central role in the realization of the ALERT physics program at Jefferson Lab 
