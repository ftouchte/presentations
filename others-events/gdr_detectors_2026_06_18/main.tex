...
\begin{frame}{Time2distance calibration}
    \begin{itemize}
        \item Ongoing work on the time2distance calibration is being done to improve the overall resolution of the detector
        \item Easy fix : use different T2D for each layer
        \item 
    \end{itemize}
